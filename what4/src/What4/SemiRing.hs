...
sr_hashWithSalt SemiRingFFRepr{}     = error "TODO RGS: Add this instance to parameterized-utils (or just unwrap the Fin)" -- hashWithSalt
...
zero (SemiRingFFRepr _) = error "TODO RGS"
...
one (SemiRingFFRepr _) = error "TODO RGS"
...
add (SemiRingFFRepr _) = error "TODO RGS"
...
mul (SemiRingFFRepr _) = error "TODO RGS"

...
| Feature                               | ABC | Bitwuzla | Boolector   | CVC5  | Dreal | STP         | Yices    | Z3                   |
|---------------------------------------|-----|----------|-------------|-------|-------|-------------|----------|----------------------|
| Supported                             | yes | yes      | >= 3.2.0, ? | 1.0.2 | yes   | >= 2.3.3, ? | 2.6.x, ? | 4.8.8 -- 4.8.14      |
| goal timeouts                         | ?   | yes      | yes         | yes   | ?     | yes         | yes      | ! (4.8.11 or 4.8.12) |
| strings with unicode and escape codes | ?   | no       | ?           | yes   | ?     | ?           | ?        | >= 4.8.11            |

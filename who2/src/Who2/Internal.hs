...
-- | Items in this module should /not/ be considered part of Who2's API, they
-- are exported only for the sake of the test suite.
module Who2.Internal
  ( assertionsEnabled
  ) where
...
-- pass the correct flags to GHC for the @lib:who2@ target. We verify that we
